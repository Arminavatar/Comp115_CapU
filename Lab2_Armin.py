...
print(f"the area of a the circle with radius 2 is {area_of_circle}")
...
print(f"Your trip starts on day {day_today}, lasts {days_trip} days. " f"You are back on day {day_return}.")
