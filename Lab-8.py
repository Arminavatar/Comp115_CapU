...
def remove_duplicates_set(s):
    ...
    using a set to track characters that have already been seen.
...
def gem_counting(stones, gems):
    ...
    stones: string where each character represents a type of stone collected
    gems: string where each character represents a type of gem

    The function converts the gems string to a set for efficient lookup,
    then counts how many characters in stones appear in that set.
...
def students_id(ids):
    ...
    ids: list of student ID strings

    The function uses a set to remove duplicate IDs and
    returns the count of unique students who used the shuttle.
...
def students_id_occurrences(ids):
    """
    Returns the occurrences of each student ID in the list.

    ids: list of student ID strings.

    The function counts how many times each student ID appears
    and returns the result as a dictionary where the key is the
    student ID and the value is the number of occurrences.
...
def word_frequency(paragraph):
    ...
    paragraph: a string containing a sentence or paragraph.

    The function extracts words using regular expressions and
    counts how many times each word appears. It returns a dictionary
